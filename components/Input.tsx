...
export const ColorButton = (props: JSX.HTMLAttributes<HTMLButtonElement>) => (
  <button
    {...props}
    disabled={!IS_BROWSER || props.disabled}
...
export const LinkButton = (props: JSX.HTMLAttributes<HTMLAnchorElement>) => (
  <a
    {...props}
...
export const Input = (props: JSX.HTMLAttributes<HTMLInputElement>) => (
  <input
    {...props}
    disabled={!IS_BROWSER || props.disabled}
    class={`px-3 py-2 bg-white rounded border(gray-300 2) disabled:(opacity-50 cursor-not-allowed focus:border-gray-500 flex w-2/5) ${
      props.class ?? ''
    }`}
  />
)
...
export const Spinner = () => (
  <div role='status'>
    <svg
      aria-hidden='true'
      class='w-16  h-16 mr-2 text-gray-100 text-center animate-spin dark:text-gray-100 fill-blue-600'
      viewBox='0 0 100 101'
      fill='none'
